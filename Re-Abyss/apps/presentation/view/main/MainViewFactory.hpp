...
namespace abyss
{
	...
	public:
		...
		virtual std::unique_ptr<IWorldObjectView> createViewFromModel(const std::shared_ptr<SlimeModel>&)const = 0;
		// camera work
	...
	public:
		...
		std::unique_ptr<IWorldObjectView> createViewFromModel(const std::shared_ptr<SlimeModel>&)const;
