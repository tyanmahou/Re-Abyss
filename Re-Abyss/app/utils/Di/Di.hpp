...
namespace abyss::di
{
    ...
    class Container
    {
        ...
        public:
            ...
            auto fromInstance(const CreateFunc<Type>& func)
            {
...
friend auto operator|(ThisType& a, const ::abyss::di::detail::AutoInjectLine<__LINE__>& l){\
    static_assert(__LINE__ < ::abyss::di::detail::AUTO_INJECT_MAX_LINES);\
