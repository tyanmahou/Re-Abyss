...
namespace abyss::UI::Home::Top
{
    ModeUpdater::ModeUpdater()
    {
        ...
        m_changerMap[Mode::Guild] = { Mode::Seek, Mode::Collect, Mode::Memory, Mode::Maint };
        m_changerMap[Mode::Maint] = { Mode::Seek, Mode::Memory, s3d::none, s3d::none };
        m_changerMap[Mode::Memory] = { Mode::Guild, Mode::Option, s3d::none, Mode::Maint };
        m_changerMap[Mode::Collect] = { s3d::none, s3d::none, Mode::Guild, Mode::Guild};
