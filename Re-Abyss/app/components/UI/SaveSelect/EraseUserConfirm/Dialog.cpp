...
namespace abyss::UI::SaveSelect::EraseUserConfirm
{
    ...
    void Dialog::onDraw() const
    {
        ...
        FontAsset(FontName::UserInfo)(MsgUtil::SaveSlect_EraseUser_Title).drawAt(msgPos);

        auto choicePos = board.center() + Param::Confirm::ChoiceBasePos;
        FontAsset(FontName::UserInfo)(MsgUtil::Decide).drawAt(choicePos);
        FontAsset(FontName::UserInfo)(MsgUtil::No).drawAt(choicePos + Vec2{ 0, Param::Confirm::ChoiceOffset });
